...
This action can apply to a single work item's scope or to the project as a whole. Use judgment — a small bugfix may need no documentation pass, while a feature that changes setup steps or adds new capabilities almost certainly does.
